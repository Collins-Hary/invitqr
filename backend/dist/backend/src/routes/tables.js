...
router.post('/:eventId/tables', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
...
router.get('/:eventId/tables', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
        const eventId = req.params.eventId;
        const event = await prisma.event.findFirst({ where: { id: eventId, user_id: user.id } });
...
router.get('/:eventId/tables/:tableId', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
        const eventId = req.params.eventId;
...
router.patch('/:eventId/tables/:tableId', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
        const eventId = req.params.eventId;
        const tableId = req.params.tableId;
...
router.delete('/:eventId/tables/:tableId', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
        const eventId = req.params.eventId;
        const tableId = req.params.tableId;
...
router.patch('/:eventId/guests/:guestId/assign-table', authMiddleware, async (req, res, next) => {
    try {
        const user = req.user;
        const eventId = req.params.eventId;
